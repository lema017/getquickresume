        ...
        <div className="flex items-center justify-between p-6 border-b flex-shrink-0">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900">
              {t('wizard.steps.projects.ai.enhance.title')}
            </h3>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {projectName && (
            <div className="mb-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <span className="font-medium">Proyecto:</span> {projectName}
              </p>
            </div>
          )}
          ...
          {isLoading && (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-2 text-gray-600">{t('wizard.steps.projects.ai.enhance.loading')}</span>
            </div>
          )}
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
              ...
              >
                {t('wizard.steps.projects.ai.enhance.retry')}
              </button>
            </div>
          )}
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  {t('wizard.steps.projects.ai.enhance.original')}
                </h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  {t('wizard.steps.projects.ai.enhance.enhanced')}
                </h4>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-sm text-green-800">
                  <strong>✨ {t('wizard.steps.projects.ai.enhance.improvements')}</strong>
                </p>
              </div>
            </div>
          )}
          ...
          {!isLoading && !error && !enhancedText && (
            <div className="text-center py-8">
              <p className="text-gray-500">{t('wizard.steps.projects.ai.enhance.error')}</p>
            </div>
          )}
        </div>
        ...
        {!isLoading && !error && enhancedText && (
          <div className="flex items-center justify-between p-6 border-t bg-gray-50 flex-shrink-0">
            <p className="text-sm text-gray-600">
              {t('wizard.steps.projects.ai.enhance.review')}
            </p>
            <div className="flex space-x-3">
              ...
              >
                ...
                <span>{t('wizard.steps.projects.ai.enhance.reject')}</span>
              </button>
              <button
              ...
              >
                ...
                <span>{t('wizard.steps.projects.ai.enhance.approve')}</span>
              </button>
            </div>
          </div>
        )}
