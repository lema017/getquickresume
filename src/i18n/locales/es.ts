export const es = {
  ...
  landing: {
    ...
    hero: {
      ...
      subtitle: 'Empieza gratis en 60 segundos. Adapta tu CV a los trabajos que realmente quieres.',
      description: 'Creador con IA + adaptación al puesto + plantillas compatibles con ATS + traducción — todo en un solo lugar.',
      badge: '🎁 Empieza gratis — Sin tarjeta',
