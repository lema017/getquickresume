  ...
  landing: {
    hero: {
      ...
      animatedFeatures: [
        ...
        { icon: 'target', text: 'Adaptación para Empleos' },
        { icon: 'bar-chart', text: 'Optimización ATS' },
