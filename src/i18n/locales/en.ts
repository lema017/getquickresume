export const en = {
  ...
  landing: {
    ...
    hero: {
      ...
      subtitle: 'Start free in 60 seconds. Tailor your resume to the jobs you actually want.',
      description: 'AI resume builder + job tailoring + ATS-friendly templates + translation — all in one place.',
      badge: '🎁 Start free — No credit card',
  ...
  dashboard: {
    ...
    stats: {
      ...
      premiumDescription: '40 resumes per month',
      upgradeToPremium: 'Upgrade to Premium',
      planType: {
