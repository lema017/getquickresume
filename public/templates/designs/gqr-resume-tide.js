/**
 * name: gqr-resume-tide
 * description: "Estilo moderno azul con acentos geométricos, tipografía limpia y títulos en mayúsculas; look corporativo con separadores sutiles y bloques bien espaciados, en una sola columna."
 */
(function () {
    'use strict';
    ...
    // ---------- Component ----------
    class GQRResumeTide extends HTMLElement {
      ...
      render() {
        ...
        const css = `
          ...
          /* Subtle geometric accents (single column) */
          .page:before{
            content:"";
            position:absolute;
            top: 0;
            ...
            width: 100%;
            height: 58px;
            background: linear-gradient(135deg, rgba(14,60,99,.14), rgba(14,60,99,0));
            pointer-events:none;
          }
          .page:after{
            content:"";
            ...
            width: 210px;
            height: 170px;
            background: linear-gradient(315deg, rgba(14,60,99,.18), rgba(14,60,99,0));
          ...
          .header{
            ...
            gap: 18px;
            padding-bottom: 14px;
            border-bottom: 1px solid rgba(12,34,54,.14);
          }
          ...
          .cicon{
            ...
            height: 18px;
            border-radius: 6px;
            background: rgba(14,60,99,.12);
            border: 1px solid rgba(14,60,99,.18);
            display:inline-flex;
            align-items:center;
            justify-content:center;
            font-size: 11px;
            color: rgba(14,60,99,.95);
            flex: 0 0 auto;
          }
          ...
          a{
            ...
            border-bottom: 1px solid rgba(14,60,99,.28);
          }
          ...
          /* Skills list (bullets like reference, but single column) */
          .bullets-compact{
            margin: 0;
            padding-left: 18px;
          }
          ...
          .entry{
            padding: 10px 0;
            border-top: 1px solid rgba(12,34,54,.10);
          }
          .entry:first-of-type{
            border-top: none;
            padding-top: 0;
        ...
        const skillsHtml = skills.length
          ? sectionWrap(
              ...
              `<ul class="bullets-compact">
                ${skills.map((s, idx) => `<li data-entry-id="skill-${idx}">${escapeHtml(s)}</li>`).join('')}
              </ul>`
            )
          : '';
    ...
    if (!customElements.get('gqr-resume-tide')) {
      customElements.define('gqr-resume-tide', GQRResumeTide);
    }
  })();