/**
 * name: gqr-resume-pebble
 * description: "Estilo editorial gris minimalista con cabecera amplia (sin foto), tipografía limpia, contacto en chips y secciones en mayúsculas con separador; experiencia en lista con bullets discretos en una sola columna."
 */
(function () {
    'use strict';
    ...
    // ---------- Component ----------
    class GQRResumePebble extends HTMLElement {
      ...
      render() {
        ...
        const css = `
          ...
          /* Skills bullets (simple like image) */
          .bullets-compact{
            margin: 0;
            padding-left: 16px;
          }
        ...
        const headerHtml = `
          <div class="topband" data-section="header">
            <div class="head">
              <div class="hgroup">
    ...
    if (!customElements.get('gqr-resume-pebble')) {
      customElements.define('gqr-resume-pebble', GQRResumePebble);
    }
  })();