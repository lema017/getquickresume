/**
 * name: gqr-resume-skyline
 * description: "Plantilla minimalista azul claro con banda superior suave, títulos en navy, secciones en mayúsculas con línea fina y contenido aireado; estilo limpio y profesional en una sola columna."
 */
(function () {
    'use strict';
    ...
    // ---------- Component ----------
    class GQRResumeSkyline extends HTMLElement {
      ...
      render() {
        ...
        // 1) Header
        const headerHtml = `
          <div class="band" data-section="header">
            <div class="header">
              <div>
    ...
    if (!customElements.get('gqr-resume-skyline')) {
      customElements.define('gqr-resume-skyline', GQRResumeSkyline);
    }
  })();