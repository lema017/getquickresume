/**
 * name: gqr-resume-almond
 * description: "Estilo moderno beige/blanco con cabecera limpia, tipografía elegante, secciones con icono circular, divisores sutiles y bloques aireados; todo en una sola columna con look editorial."
 */
(function () {
    'use strict';
    ...
    // ---------- Component ----------
    class GQRResumeAlmond extends HTMLElement {
      ...
      render() {
        ...
        function sectionWrap(sectionKey, title, iconText, innerHtml) {
          return `
            <section class="section" data-section="${escapeHtml(sectionKey)}">
              <div class="section-head">
                <div class="sicon" aria-hidden="true">${escapeHtml(iconText)}</div>
    ...
    if (!customElements.get('gqr-resume-almond')) {
      customElements.define('gqr-resume-almond', GQRResumeAlmond);
    }
  })();