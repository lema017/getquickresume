...
exports.SECURITY_PREAMBLE_SCOPED = exports.SECURITY_PREAMBLE = void 0;
 ...
 */
exports.SECURITY_PREAMBLE_SCOPED = `
SECURITY CONTEXT:
 ...
 */
function validatePublicTranslationInput(body, contentType) {
 ...
 * Returns sanitized text on success, or a rejection reason on failure.
 */
function validatePublicAtsCheckInput(body, contentType) {
    if (!contentType || !contentType.includes('application/json')) {
        return { isValid: false, reason: 'Content-Type must be application/json' };
    }
    if (!body) {
 ...
 */
function validateInputForPublicEndpoint(input) {
    if (!input || typeof input !== 'string') {
        return { isValid: false, reason: 'Input is required' };
    }
    if (input.length === 0) {
